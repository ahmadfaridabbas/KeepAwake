...
struct GlassyMenuBarView: View {
    ...
    @ObservedObject var preferencesWindowManager: PreferencesWindowManager
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            LazyVGrid(columns: [
                ...
                ForEach(KeepAwakeManager.timerPresets, id: \.self) { duration in
                    ...
                    .font(.system(size: 12, weight: .medium))
                    .foregroundStyle(manager.isAwake ? Color.secondary : Color.primary)
                    .padding(.vertical, 6)
                    .frame(maxWidth: .infinity)
                    .background(
            ...
            .font(.system(size: 12, weight: .medium))
            .foregroundStyle(manager.isAwake ? Color.secondary : Color.blue)
            .frame(maxWidth: .infinity)
            .padding(.vertical, 6)
            .background(
                RoundedRectangle(cornerRadius: 6)
    ...
    private var settingsSection: some View {
        VStack(spacing: 8) {
            Button("Preferences...") {
                preferencesWindowManager.showPreferences(preferences: preferences)
            }
    ...
    private func progressWidth(_ totalWidth: CGFloat) -> CGFloat {
        ...
        return totalWidth * manager.timerProgress
    }
}
